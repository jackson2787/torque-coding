...
- Template source: `v2/bootstrap-memory-bank-v2-contract.md`
...
2. **Use the v2 memory bank skills for all writes.** Each document has an update skill under `v2/skills/memory-bank-v2/`. Never write directly.
...
Use `v2/skills/memory-bank-v2/update-constitution/SKILL.md`.
...
Use `v2/skills/memory-bank-v2/update-operational-context/SKILL.md`.
...
```text
Read v2/bootstrap-memory-bank-v2-contract.md and execute it.
