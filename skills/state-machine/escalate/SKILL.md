...
Use the template at `templates/machine/current-task/escalation-brief.md`. The brief is self-contained — a stronger model reading it (possibly in a fresh session) must understand the task, what was tried, why it failed, and where to look.
